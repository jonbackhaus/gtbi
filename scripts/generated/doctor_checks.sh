...
declare -a MANIFEST_CHECKS=(
    ...
    "stack.bd.1	gastownhall beads (bd) - Dolt-backed local-first issue tracker for AI agents	bd --version	required	target_user"
    "stack.bd.2	gastownhall beads (bd) - Dolt-backed local-first issue tracker for AI agents	bd stats 2>/dev/null	optional	target_user"
