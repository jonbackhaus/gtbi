...
source "$GTBI_GENERATED_SCRIPT_DIR/install_base.sh"
source "$GTBI_GENERATED_SCRIPT_DIR/install_users.sh"
source "$GTBI_GENERATED_SCRIPT_DIR/install_filesystem.sh"
source "$GTBI_GENERATED_SCRIPT_DIR/install_shell.sh"
source "$GTBI_GENERATED_SCRIPT_DIR/install_cli.sh"
source "$GTBI_GENERATED_SCRIPT_DIR/install_tools.sh"
...
install_all() {
    log_section "GTBI Full Installation"
