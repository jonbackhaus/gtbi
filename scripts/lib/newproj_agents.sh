#!/usr/bin/env bash
# ============================================================
# GTBI newproj TUI Wizard - AGENTS.md Generator
# Generates tech-stack-aware AGENTS.md files for new projects
# ============================================================

# Prevent multiple sourcing
if [[ -n "${_GTBI_NEWPROJ_AGENTS_SH_LOADED:-}" ]]; then
    return 0
fi
_GTBI_NEWPROJ_AGENTS_SH_LOADED=1
...
Generated by \`gtbi newproj --interactive\` on ${AGENTS_GENERATED_AT:-unknown}.
