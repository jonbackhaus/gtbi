...
export const jargonDictionary: Record<string, JargonTerm> = {
  ...
  chmod: {
    ...
    why: "When SSH says 'permissions too open,' it means your private key is readable by others and could be stolen. Running 'chmod 600 ~/.ssh/gtbi_ed25519' fixes this by making it owner-only. This is one of the most common SSH troubleshooting steps.",
  ...
  ed25519: {
    ...
    why: "We use Ed25519 for the SSH keys generated by the wizard because it's the most secure option that works everywhere. The key file is named 'gtbi_ed25519' because it uses this algorithm. If a server doesn't accept it (very rare, usually ancient systems), RSA is the fallback.",
