...
const _tldrFlywheelTools: TldrFlywheelTool[] = [
  ...
  },
  {
    ...
    whyItsUseful:
      "Setting up a new development environment takes hours. GTBI does it in 30 minutes, installing 30+ tools, three AI agents, and all flywheel tooling. Post-install CLI provides `gtbi doctor` for health checks and `gtbi update` for maintenance.",
    implementationHighlights: [
      "Single curl | bash installation with SHA256 verification",
      "Idempotent and resumable installation",
      "Manifest-driven architecture (gtbi.manifest.yaml)",
    ...
    keyFeatures: [
      "gtbi doctor: 47+ health checks across 7 categories",
      "gtbi doctor --deep: Functional tests (auth, DB connectivity)",
      "gtbi update: Category-specific with --dry-run preview",
      "gtbi cheatsheet: 50+ aliases for modern CLI tools",
      "gtbi dashboard: Static HTML dashboard generation",
      "Update logging to ~/.gtbi/logs/updates/",
    ],
    useCases: [
      "Setting up new development VPS",
      "Ongoing maintenance with gtbi doctor and gtbi update",
